document.addEventListener("DOMContentLoaded",() => {
	let button = new ExplosiveButton("cicakutyaButton");
});

function displayRandomGIFsInterval () {
    setInterval(displayRandomGIFs, 2800);
};

function addcicakutyaVideo() {

    /* add cicakutya-video element */
    const videoElement = document.createElement('video');
    videoElement.id = 'cicakutya-video';
    videoElement.src = 'assets/videos/cicakutya.mp4';
    videoElement.autoplay = true;
    videoElement.loop = true;

    // Get a reference to the container element where you want to add the video
...
class ExplosiveButton {
	constructor(el) {
		...
		this.piecesY = 4;
		this.duration = 1000;
        this.sound = document.getElementById("cicakutyaSound");
		...
		if (document.body.animate)
            ...
            this.element.addEventListener("click", addcicakutyaVideo);
            this.element.addEventListener("click", displayRandomGIFsInterval);
